    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Create New degradation_rank_internal1_picture</div>
                <div class="panel-body">
                    ...
                    <form method="POST" action="/degradation_rank_internal1/store" class="form-horizontal">
                        {{ csrf_field() }}
