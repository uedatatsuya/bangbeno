    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Create New improvement_rank_internal1_picture</div>
                <div class="panel-body">
                    ...
                    <form method="POST" action="/improvement_rank_internal1/store" class="form-horizontal">
                        {{ csrf_field() }}
