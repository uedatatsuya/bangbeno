        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="{{ route('investigation.update', $investigation->id ?? '') }}" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="py-3">
                                    <img src="{{ asset('storage/images/' . $investigation->name_plate) }}" alt="{{ $investigation->name_plate }}" width="100px">
                                </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="py-3">
                                    <img src="{{ asset('storage/images/' . $investigation->electric_meter) }}" alt="{{ $investigation->electric_meter }}" width="100px">
                                </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="py-3">
                                    <img src="{{ asset('storage/images/' . $investigation->power_meter) }}" alt="{{ $investigation->power_meter }}" width="100px">
                                </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" name="is_high_voltage_power_reception" type="text" id="is_high_voltage_power_reception" value="{{ $investigation->is_high_voltage_power_reception ?? '' }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" name="is_power_contract" type="text" id="is_power_contract" value="{{ $investigation->is_power_contract ?? '' }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="cost_reduction_1" id="cost_reduction_1">
                                    ...
                                    <option value="{{ $key }}" {{ $investigation->cost_reduction_1 == $key ? 'selected' : '' }}>
                                        {{ $value['list'] }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" name="cost_reduction_picture_1" type="file" id="cost_reduction_picture_1" value="{{ $investigation->cost_reduction_picture_1 ?? '' }}">

                                @if (isset($investigation->cost_reduction_picture_1))
                                <div class="py-3">
                                    <img src="{{ asset('storage/images/' . $investigation->cost_reduction_picture_1) }}" alt="{{ $investigation->cost_reduction_picture_1 }}" width="100px">
                                </div>
                                @endif
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="cost_reduction_comment_list_1_1" id="cost_reduction_comment_list_1_1">
                                    <option value="">-</option>
                                    @foreach (config('const.cost_reductions')['1']['comments'] as $key => $value)
                                    <option value="{{ $key }}" data-comment="{{ $value['comment'] }}" {{ $investigation->cost_reduction_comment_list_1 == $key ? 'selected' : '' }}>
                                        {{ $value['list'] }}
                                    </option>
                                    @endforeach
                                </select>

                                <select class="form-control" name="cost_reduction_comment_list_1_2" id="cost_reduction_comment_list_1_2">
                                    <option value="">-</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="cost_reduction_2" id="cost_reduction_2">
                                    <option value="">-</option>
                                    @foreach (config('const.cost_reductions') as $key => $value)
                                    <option value="{{ $key }}" {{ $investigation->cost_reduction_2 == $key ? 'selected' : '' }}>
                                        {{ $value['list'] }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" name="cost_reduction_picture_2" type="file" id="cost_reduction_picture_2" value="{{ $investigation->cost_reduction_picture_2 ?? '' }}">

                                @if (isset($investigation->cost_reduction_picture_2))
                                <div class="py-3">
                                    <img src="{{ asset('storage/images/' . $investigation->cost_reduction_picture_2) }}" alt="{{ $investigation->cost_reduction_picture_2 }}" width="100px">
                                </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="cost_reduction_comment_list_2_1" id="cost_reduction_comment_list_2_1">
                                    <option value="">-</option>
                                    @foreach (config('const.cost_reductions')['1']['comments'] as $key => $value)
                                    <option value="{{ $key }}" data-comment="{{ $value['comment'] }}" {{ $investigation->cost_reduction_comment_list_1 == $key ? 'selected' : '' }}>
                                        {{ $value['list'] }}
                                ...
                                <select class="form-control" name="cost_reduction_comment_list_2_2" id="cost_reduction_comment_list_2_2">
                                    <option value="">-</option>
                                    @foreach (config('const.cost_reductions')['2']['comments'] as $key => $value)
                                    <option value="{{ $key }}" data-comment="{{ $value['comment'] }}" {{ $investigation->cost_reduction_comment_list_2 == $key ? 'selected' : '' }}>
                                        {{ $value['list'] }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        有</option>
                        <option value="2" {{ $investigation->is_renewal_board == 2 ? 'selected' : '' }}>
                            無</option>
                        </select>
                </div>
            </div> --}}
            ...
            <div class="form-group">
                <div class="col-md-6">
                    <div class="custom-control custom-switch">
                        ...
                        <input type="checkbox" class="custom-control-input" id="is_renewal_board" name="is_renewal_board" {{ $investigation->is_renewal_board == 'on' ? 'checked' : '' }}>
                        <label class="custom-control-label" for="is_renewal_board">更新済みの盤の有無</label>
            ...
            <example-component2 v-bind:investigation-id="{{$investigation->id}}"></example-component2>
